...
return [
    ...
    'faq' => [
        [
            ...
            'a' => 'We offer vulnerability assessments, penetration testing, SOC-as-a-service, SIEM implementation, incident response, and compliance consulting for GDPR, ISO 27001, PCI DSS, and more.',
        ],
        [
            'q' => 'How do you assess our security posture?',
            'a' => 'We conduct a comprehensive threat assessment covering network infrastructure, applications, endpoints, and human factors — including automated scanning and manual testing.',
        ],
        [
            'q' => 'Do you help with regulatory compliance?',
            'a' => 'Yes. We help organisations achieve and maintain compliance with GDPR, ISO 27001, PCI DSS, HIPAA, SOC 2, and other international security frameworks.',
        ],
        [
            'q' => 'What happens if we experience a security breach?',
            'a' => 'Our incident response team is available 24/7. We follow a structured process — containment, eradication, recovery, and root cause analysis — to minimise damage and prevent recurrence.',
        ],
        [
            'q' => 'How often should we conduct security assessments?',
            'a' => 'We recommend quarterly vulnerability scans, annual penetration tests, and continuous monitoring. High-risk environments may require more frequent assessments.',
        ],
    ],
    'process' => [
