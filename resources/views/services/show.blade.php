...
$star14 = '<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14">
    <path
...
$star15 = '<svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 15 15">
    <path
            ...
            <div class="row g-lg-4 gy-5 align-items-center">
                ...
                <div class="col-lg-6 order-lg-2 order-1 wow animate fadeInRight" data-wow-delay="200ms"
                    ...
                    <div class="service-details-img">
                        <img src="{{ asset('assets/theme/img/innerpage/' . ($s['img1'] ?? 'service-details-feature-img.jpg')) }}"
                            alt="{{ $s['breadcrumb'] }}">
                    </div>
                </div>
            </div>
            ...
            <div class="row g-lg-4 gy-5 align-items-xl-center">
                <div class="col-lg-6">
                    <div class="service-details-faq-img">
                        <img src="{{ asset('assets/theme/img/innerpage/' . ($s['img2'] ?? 'service-details-faq-img.jpg')) }}"
                            alt="FAQ">
                    </div>
                </div>
                <div class="col-lg-6">
                        ...
                        <div class="accordion" id="accordionServiceFaq">
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="faqCollapse{{ $i }}"
                                    ...
                                    aria-labelledby="faqHeading{{ $i }}" data-bs-parent="#accordionServiceFaq">
...
<div class="home2-process-section two mb-120">
    <div class="container">
        <div class="section-title5 text-center mb-70 wow animate fadeInDown" data-wow-delay="200ms"
            data-wow-duration="1500ms">
                ...
                <div class="col-lg-12">
                    <div class="swiper home2-process-slider">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide wow animate fadeInDown" data-wow-delay="{{ ($i + 1) * 200 }}ms"
                                data-wow-duration="1500ms">
...
<div class="service-details-feature-section mb-120">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <div class="section-title5 mb-70 wow animate fadeInLeft" data-wow-delay="200ms"
                    data-wow-duration="1500ms">
                    <span class="sub-title5 two">
                        {!! $star14 !!}
                        Service Features
                    ...
                    <p>We deliver end-to-end expertise so your projects run smoothly, securely, and at full speed from
                        day one through to long-term success.</p>
                </div>
            </div>
            <div class="col-lg-6">
                <ul class="service-feature-list">
                    @foreach($s['featureItems'] as $i => $feat)
                    <li class="single-feature wow animate fadeInDown" data-wow-delay="{{ ($i + 1) * 200 }}ms"
                        data-wow-duration="1500ms">
                        <div class="icon">
                            {!! $fi[$feat['icon']] !!}
                        </div>
...
<div class="service-details-tools-section mb-120">
    <div class="container">
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-2 col-md-3 col-sm-4 wow animate fadeInDown" data-wow-delay="{{ $delays[$i] ?? 200 }}ms"
                data-wow-duration="1500ms">
                <div class="tools-card">
                    <div class="tools-icon">
                        <img src="{{ asset('assets/theme/img/innerpage/icon/' . $tool['icon']) }}"
                            alt="{{ $tool['name'] }}">
                    </div>
            ...
            <div class="col-lg-5">
                <div class="contact-content">
                    <div class="section-title white wow animate fadeInUp" data-wow-delay="200ms"
                        ...
                        <p>Ready to take the first step towards unlocking opportunities, realizing goals, and embracing
                            innovation? We're here and eager to connect.</p>
                    </div>
