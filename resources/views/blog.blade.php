    ...
    <div class="container">
        <div class="row mb-60 align-items-end">
            ...
            <div class="col-lg-5 wow animate fadeInRight" data-wow-delay="300ms" data-wow-duration="1500ms">
                <p>Stay up-to-date with the latest trends in technology, our project highlights, and expert insights from the Sigmix Labs team.</p>
            </div>
        </div>
        ...
        <div class="row g-md-4 gy-5">
            ...
            <div class="col-lg-8 wow animate fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
                <div class="blog-card featured">
                    <div class="blog-img">
                        <img src="{{ asset('assets/theme/img/home1/blog/blog1.jpg') }}" alt="AI in Business" class="img-fluid">
                    ...
                    <div class="blog-content">
                        ...
                        <h3><a href="#">How AI is Reshaping Enterprise Software Development in 2026</a></h3>
                        <p>Artificial intelligence is no longer a futuristic concept — it's actively transforming how businesses build, deploy, and scale their software. From intelligent code assistants to automated testing pipelines and predictive analytics, AI is embedded in every layer of the modern development stack.</p>
            ...
            <div class="col-lg-4 wow animate fadeInRight" data-wow-delay="300ms" data-wow-duration="1500ms">
                <div class="blog-card side-card mb-4">
                    <div class="blog-img">
                        <img src="{{ asset('assets/theme/img/home1/blog/blog2.jpg') }}" alt="Laravel 11" class="img-fluid">
                ...
                <div class="blog-card side-card">
                    <div class="blog-img">
                        <img src="{{ asset('assets/theme/img/home1/blog/blog3.jpg') }}" alt="Cloud Security" class="img-fluid">
            ...
            <div class="col-lg-4 col-md-6 wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                <div class="blog-card">
                    <div class="blog-img">
                        <img src="{{ asset('assets/theme/img/home1/blog/blog4.jpg') }}" alt="React Native" class="img-fluid">
                    ...
                    <div class="blog-content">
                        ...
                        <p>We break down the key differences between these two powerhouse frameworks and help you choose the right one for your next project.</p>
                        <a href="#" class="read-more-btn">
                            Read More
                            <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 10 10">
                                <path d="M8.33624 2.84003L1.17627 10L0 8.82373L7.15914 1.66376H0.849347V0H10V9.15065H8.33624V2.84003Z"/>
            ...
            <div class="col-lg-4 col-md-6 wow animate fadeInUp" data-wow-delay="300ms" data-wow-duration="1500ms">
                <div class="blog-card">
                    ...
                    <div class="blog-content">
                        ...
                        <p>A step-by-step guide to setting up CI/CD pipelines that ensure your applications are always available, even during deployments.</p>
                        <a href="#" class="read-more-btn">
                            Read More
                            <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 10 10">
                                <path d="M8.33624 2.84003L1.17627 10L0 8.82373L7.15914 1.66376H0.849347V0H10V9.15065H8.33624V2.84003Z"/>
            ...
            <div class="col-lg-4 col-md-6 wow animate fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
                <div class="blog-card">
                    <div class="blog-img">
                        <img src="{{ asset('assets/theme/img/home1/blog/blog6.jpg') }}" alt="UX Design" class="img-fluid">
                    ...
                    <div class="blog-content">
                        ...
                        <p>Discover the design principles our team uses to create user experiences that not only look great but also convert visitors into customers.</p>
                        <a href="#" class="read-more-btn">
                            Read More
                            <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 10 10">
                                <path d="M8.33624 2.84003L1.17627 10L0 8.82373L7.15914 1.66376H0.849347V0H10V9.15065H8.33624V2.84003Z"/>
            ...
            <div class="col-lg-4 col-md-6 wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                <div class="blog-card">
                    <div class="blog-img">
                        <img src="{{ asset('assets/theme/img/home1/blog/blog1.jpg') }}" alt="Microservices" class="img-fluid">
                    ...
                    <div class="blog-content">
                        ...
                        <p>We analyze real-world trade-offs between microservices and monolithic architectures based on our experience delivering 100+ projects.</p>
                        <a href="#" class="read-more-btn">
                            Read More
                            <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 10 10">
                                <path d="M8.33624 2.84003L1.17627 10L0 8.82373L7.15914 1.66376H0.849347V0H10V9.15065H8.33624V2.84003Z"/>
            ...
            <div class="col-lg-4 col-md-6 wow animate fadeInUp" data-wow-delay="300ms" data-wow-duration="1500ms">
                <div class="blog-card">
                    <div class="blog-img">
                        <img src="{{ asset('assets/theme/img/home1/blog/blog2.jpg') }}" alt="Blockchain" class="img-fluid">
                    ...
                    <div class="blog-content">
                        ...
                        <p>Real-world applications of blockchain in supply chain, healthcare, and finance that are delivering tangible value for businesses today.</p>
                        <a href="#" class="read-more-btn">
                            Read More
                            <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 10 10">
                                <path d="M8.33624 2.84003L1.17627 10L0 8.82373L7.15914 1.66376H0.849347V0H10V9.15065H8.33624V2.84003Z"/>
            ...
            <div class="col-lg-4 col-md-6 wow animate fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
                <div class="blog-card">
                    ...
                    <div class="blog-content">
                        ...
                        <p>Our proven agile process for keeping distributed teams aligned, productive, and delivering consistent value to clients across time zones.</p>
                        <a href="#" class="read-more-btn">
                            Read More
                            <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 10 10">
                                <path d="M8.33624 2.84003L1.17627 10L0 8.82373L7.15914 1.66376H0.849347V0H10V9.15065H8.33624V2.84003Z"/>
        ...
        <!-- Pagination -->
        <div class="pagination-area mt-60 d-flex justify-content-center wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
