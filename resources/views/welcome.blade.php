...
<body>
        ...
        <div class="sidebar-menu-top-area">
            <div class="container d-flex align-items-center justify-content-between">
                <div class="sidebar-menu-logo">
                    <a href="index.html" class="logo-dark"><img alt="image" class="img-fluid" src="{{ asset('assets/theme/img/logo.svg') }}"></a>
                    <a href="index.html" class="logo-light"><img alt="image" class="img-fluid" src="{{ asset('assets/theme/img/logo-light.svg') }}"></a>
                </div>
                    ...
                    <li class="menu-item-has-children active">
                        ...
                        <ul class="sub-menu">
                            <li class="active">
                                ...
                                <ul class="sub-menu">
                                    <li class="active"><a href="index.html">Startup Agency</a></li>
    ...
    <div class="home1-banner-section">  
             ...
             <div class="row">
                 <div class="col-lg-6 d-flex align-items-xxl-start align-items-center">
                     <div class="banner-content">
                         ...
                         <h1>Building Intelligent Digital Solutions with AI</h1>
                         <p>We are an AI-first agency that combines machine learning, modern web technology, and expert engineering to deliver solutions that drive real business outcomes. </p>
                         <div class="banner-content-bottom">
                             <a href="contact.html" class="primary-btn1" data-text="Free Consultation"><span>Free Consultation</span></a>
                             <a href="https://clutch.co" class="rating-area">
                                 <div class="review">
                                     <span>Review On</span>
                                     <img class="logo-dark" src="{{ asset('assets/theme/img/home1/icon/clutch-logo.svg') }}" alt="">
                                     <img class="logo-light" src="{{ asset('assets/theme/img/home1/icon/clutch-logo-white.svg') }}" alt="">
                                 </div>
                                 <div class="rating">
                                     <ul class="star">
                         ...
                         <div class="swiper banner-img-slider">
                             <div class="swiper-wrapper">
                                 <div class="swiper-slide">
                                     <img src="{{ asset('assets/theme/img/home1/banner-img1.jpg') }}" alt="">
                                 </div>
                                 <div class="swiper-slide">
                                     <img src="{{ asset('assets/theme/img/home1/banner-img2.jpg') }}" alt="">
                                 </div>
                                 <div class="swiper-slide">
                                     <img src="{{ asset('assets/theme/img/home1/banner-img3.jpg') }}" alt="">
                                 </div>
                             </div>
                         </div>
                     </div>
        ...
        <div class="video-area">
            <div class="badge">
                ...
                <span class="badge__char">.</span>
                <div class="play">
                    <a href="https://www.youtube.com/watch?v=MLpWrANjFbI" class="play-icon video1">
                ...
                <div class="col-lg-9 wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="2000ms">
                    <div class="about-content">
                        <div class="about-section-title">
                            ...
                            <h2>We are an AI-first agency delivering intelligent, scalable digital products.</h2>
                            <p>Founded on the conviction that artificial intelligence changes everything, Sigmix Labs helps businesses modernize operations, automate workflows, and build user-first digital products. </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row g-5">
                    <div class="col-lg-3 col-md-6 wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                        <div class="feature-card">
                             <div class="icon">
                                <img src="{{ asset('assets/theme/img/home1/icon/about-feature-card-icon1.svg') }}" alt="">
                             </div>
                             <div class="content">
                    ...
                    <div class="col-lg-3 col-md-6 wow animate fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
                        <div class="feature-card">
                             <div class="icon">
                                <img src="{{ asset('assets/theme/img/home1/icon/about-feature-card-icon2.svg') }}" alt="">
                             </div>
                             <div class="content">
                    ...
                    <div class="col-lg-3 col-md-6 wow animate fadeInUp" data-wow-delay="600ms" data-wow-duration="1500ms">
                        <div class="feature-card">
                             <div class="icon">
                                <img src="{{ asset('assets/theme/img/home1/icon/about-feature-card-icon3.svg') }}" alt="">
                             </div>
                             <div class="content">
                    ...
                    <div class="col-lg-3 col-md-6 wow animate fadeInUp" data-wow-delay="800ms" data-wow-duration="1500ms">
                        <div class="feature-card">
                             <div class="icon">
                                <img src="{{ asset('assets/theme/img/home1/icon/about-feature-card-icon4.svg') }}" alt="">
                             </div>
                             <div class="content">
        ...
        <div class="container">
            <div class="row mb-60">
                <div class="col-lg-12 d-flex align-items-center justify-content-between flex-wrap gap-3">
                    ...
                    <a href="service.html" class="primary-btn2 wow animate fadeInRight" data-wow-delay="400ms" data-wow-duration="1500ms" data-text="Explore More"><span>Explore More</span></a>
                </div>
            </div>
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <div class="service-card">
                        <div class="content">
                            <h4><a href="service-details.html">Web & App Development</a></h4>
                            ...
                            <p>Build fast, scalable, and AI-enhanced web and mobile applications tailored to your business needs.</p>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
                    <div class="service-card">
                        <div class="content">
                            <h4><a href="service-details.html">Consulting Services</a></h4>
                            <svg xmlns="http://www.w3.org/2000/svg" width="55" height="55" viewBox="0 0 55 55">
                                <g>
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                        d="M45.4416 6.50406C45.5555 6.50389 45.6646 6.45861 45.7452 6.37814C45.8258 6.29767 45.8712 6.18856 45.8715 6.07469C45.8714 5.96071 45.826 5.85143 45.7454 5.77083C45.6648 5.69023 45.5556 5.6449 45.4416 5.64479H33.566C33.4521 5.6449 33.3428 5.69025 33.2623 5.77086C33.1818 5.85148 33.1366 5.96076 33.1366 6.07469C33.1368 6.18851 33.1821 6.2976 33.2626 6.37808C33.3431 6.45856 33.4522 6.50386 33.566 6.50406H45.4416ZM45.4416 8.99506H33.566C33.4521 8.99535 33.343 9.04075 33.2625 9.12133C33.182 9.2019 33.1368 9.31108 33.1366 9.42497C33.1366 9.48139 33.1477 9.53727 33.1692 9.58941C33.1908 9.64155 33.2224 9.68894 33.2623 9.72886C33.3021 9.76878 33.3495 9.80045 33.4016 9.82208C33.4537 9.8437 33.5096 9.85484 33.566 9.85487H45.4416C45.5556 9.85484 45.6649 9.80954 45.7455 9.72892C45.8262 9.64831 45.8715 9.53897 45.8715 9.42497C45.8712 9.31103 45.8259 9.20183 45.7453 9.12126C45.6647 9.04069 45.5555 8.99532 45.4416 8.99506ZM45.0425 50.435L36.5059 52.7849C35.5474 53.0489 34.5422 52.48 34.2769 51.5215C34.0106 50.5596 34.5788 49.5569 35.5412 49.292L43.1978 47.184L45.6401 38.1835C45.702 37.9557 45.565 37.7176 45.3372 37.656C45.109 37.5942 44.8713 37.7297 44.8094 37.958L42.3215 47.1332L41.4114 43.7376C41.4081 43.727 41.4053 43.7163 41.4031 43.7054L41.1032 42.5885C41.0421 42.3605 40.805 42.2232 40.577 42.2845C40.467 42.3143 40.3734 42.3865 40.3165 42.4853C40.2596 42.584 40.2442 42.7013 40.2735 42.8114L40.5367 43.7937L39.0302 47.0632C38.9673 47.1988 38.8879 47.3261 38.7937 47.4421L38.7285 47.5228L36.0664 48.256L28.609 49.0179L28.9002 48.4815C29.1229 48.07 29.2335 47.6071 29.2208 47.1394C29.2082 46.6716 29.0727 46.2155 28.828 45.8166L28.5593 45.3794L35.9215 44.6277C35.9958 44.6201 36.0668 44.5934 36.1276 44.5501C36.1884 44.5068 36.2368 44.4484 36.2682 44.3807L39.6296 37.0866C40.4673 35.2688 41.3366 33.3211 43.4556 32.7532C44.6941 32.4213 45.9986 32.5988 47.1086 33.2399C48.2216 33.8827 49.0231 34.9176 49.3559 36.1596L52.646 48.4391C52.7862 48.9623 52.8517 49.4542 52.8517 49.996V52.8517H43.2567V51.8184
                                </g>
                            </svg>
                            <p>Navigate your AI transformation with confidence. We help businesses identify opportunities, build AI roadmaps, and execute with precision.</p>
                        </div>
                        <a href="service-details.html" class="explore-btn"> EXPLORE MORE 
                            <svg xmlns="http://www.w3.org/2000/svg" width="17" height="9" viewBox="0 0 17 9">
                                <path
                ...
                <div class="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
                    <div class="service-card">
                        <div class="content">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="55" height="55" viewBox="0 0 55 55">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    d="M40.3529 18.8065H36.6219C36.2011 17.6553 35.6934 16.5764 35.1044 15.5956C34.5188 14.6214 33.8741 13.7763 33.1816 13.0671C36.1109 14.2194 38.6071 16.238 40.3529 18.8065ZM33.1816 41.9324C33.8741 41.2231 34.5188 40.3781 35.1044 39.4039C35.6934 38.423 36.2011 37.3442 36.6219 36.1929H40.3529C38.6071 38.7615 36.1109 40.78 33.1816 41.9324ZM14.6985 36.1929H18.4295C18.8503 37.3442 19.358 38.423 19.947 39.4039C20.5326 40.3781 21.1773 41.2231 21.8698 41.9324C18.9405 40.78 16.4443 38.7615 14.6985 36.1929ZM21.8698 13.0671C21.1773 13.7763 20.5326 14.6214 19.947 15.5956C19.358 16.5764 18.8503 17.6553 18.4295 18.8065H14.6985C16.4443 16.238 18.9405 14.2194 21.8698 13.0671ZM28.3051 18.8065H34.9552C34.6123 17.9492 34.2159 17.1431 33.7684 16.3983C32.2553 13.881 30.3392 12.3679 28.3051 12.0595V18.8065ZM36.5162 26.7204H28.3051V20.3652H35.5019C36.102 22.3214 36.4505 24.4758 36.5162 26.7204ZM38.0749 28.2791H43.0071C42.8936 30.5615 42.2834 32.7148 41.2836 34.6342H37.1274C37.6897 32.6546 38.0125 30.5036 38.0749 28.2791ZM28.3051 34.6342V28.2791H36.5162C36.4505 30.5236 36.102 32.678 35.5019 34.6342H28.3051ZM28.3051 42.94C30.3392 42.6316 32.2553 41.1185 33.7684 38.6012C34.2159 37.8563 34.6123 37.0502 34.9552 36.1929H28.3051V42.94ZM26.7463 36.1929H20.0962C20.4391 37.0502 20.8354 37.8563 21.283 38.6012C22.7961 41.1185 24.7122 42.6316 26.7463 42.94V36.1929ZM18.5352 28.2791H26.7463V34.6342H19.5495C18.9494 32.678 18.6009 30.5236 18.5352 28.2791ZM16.9765 26.7204H12.0443C12.1578 24.438 12.768 22.2847 13.7678 20.3652H17.924C17.3617 22.3448 17.0389 24.4958 16.9765 26.7204ZM20.0962 18.8065H26.7463V12.0595C24.7122 12.3679 22.7961 13.881 21.283 16.3983C20.8354 17.1431 20.4391 17.9492 20.0962 18.8065ZM26.7463 20.3652V26.7204H18.5352C18.6009 24.4758 18.9494 22.3214 19.5495 20.3652H26.7463ZM12.0443 28.2791H16.9765C17.0389 30.5036 17.3617 32.6546 17.924 34.6342H13.7678C12.7413 32.6651 12.1533 30.497 12.0443 28.2791ZM43.0071 26.7204H38.0749C38.0125 24.4958 37.6897 22.3448 37.1274 20.3652H41.2836C42.3101 22.3344 42.8981 24.5024 43.0071 26.7204ZM10.4666 27.4997C10.4666 36.9066 18.1188 44.5588 27.5257 44.5588C36.9326 44.5588 44.5848 36.9066 44.5848 27.4997C44.5848 18.0928 36.9326 10.4406 27.5257 10.4406C18.1188 10.4406 10.4666 18.0928 10.4666 27.4997ZM48.7944 29.0451V11.1254C41.1255 10.4239 34.1547 7.36774 27.5257 1.802C20.8967 7.36774 13.9259 10.4239 6.25696 11.1254V29.0451C6.25696 36.272 8.99252 42.4278 14.1664 46.8446C17.8193 49.9631 22.1904 52.1153 27.5257 53.419C32.861 52.1153 37.2321 49.9631 40.885 46.8446C46.06 42.4278 48.7944 36.272 48.7944 29.0451ZM49.6295 9.63011C41.8236 9.06897 34.7593 5.98048 28.0345 0.188725C27.893 0.0669613 27.7124 0 27.5257 0C27.339 0 27.1584 0.0669613 27.0169 0.188725C20.2921 5.98048 13.2278 9.06897 5.42193 9.63011C5.22541 9.64419 5.04152 9.73217 4.90725 9.87635C4.77298 10.0205 4.6983 10.2102 4.69824 10.4072V29.0451C4.69824 36.7429 7.62196 43.3074 13.1543 48.0303C17.04 51.3481 21.6816 53.6205 27.3442 54.9788C27.4032 54.9933 27.4645 55 27.5257 55C27.5869 55 27.6482 54.9933 27.7072 54.9788C33.3698 53.6205 38.0114 51.3481 41.8971 48.0303C47.4294 43.3074 50.3531 36.7429 50.3531 29.0451V10.4072C50.3531 10.2102 50.2784 10.0205 50.1441 9.87635C50.0099 9.73217 49.826 9.64419 49.6295 9.63011Z"/>
                            </svg>
                            <p>Protect your AI systems and data with comprehensive cybersecurity solutions—built for modern, cloud-native environments.</p>
                        </div>
                        <a href="service-details.html" class="explore-btn"> EXPLORE MORE 
                            <svg xmlns="http://www.w3.org/2000/svg" width="17" height="9" viewBox="0 0 17 9">
                                <path
                ...
                <div class="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms">
                    <div class="service-card">
                        <div class="content">
                            <h4><a href="service-details.html">E-commerce Solutions</a></h4>
                            <svg xmlns="http://www.w3.org/2000/svg" width="55" height="55" viewBox="0 0 55 55">
                                <path
                                    d="M54.3702 18.9006C54.2875 18.9006 54.2056 18.9169 54.1292 18.9485C54.0528 18.9802 53.9833 19.0266 53.9249 19.0851C53.8664 19.1436 53.82 19.213 53.7883 19.2894C53.7567 19.3658 53.7404 19.4477 53.7404 19.5304V45.6113C53.7404 46.8961 52.6951 47.9414 51.4103 47.9414H3.58987C2.30488 47.9414 1.25959 46.8961 1.25959 45.6113V19.5304C1.25959 19.1826 0.977746 18.9006 0.629793 18.9006C0.281839 18.9006 0 19.1825 0 19.5304V45.6113C0 47.5906 1.61029 49.201 3.58976 49.201H51.4102C53.3895 49.201 54.9999 47.5907 54.9999 45.6113V19.5304C54.9999 19.4477 54.9837 19.3658 54.952 19.2894C54.9204 19.213 54.874 19.1436 54.8155 19.0851C54.7571 19.0266 54.6876 18.9802 54.6112 18.9485C54.5348 18.9169 54.4529 18.9006 54.3702 18.9006Z"/>
                                <path
                                <path
                                    d="M14.8795 18.8695C13.6401 18.8695 12.6318 17.8612 12.6318 16.6218C12.6318 15.3824 13.6401 14.3742 14.8795 14.3742C16.1189 14.3742 17.1272 15.3824 17.1272 16.6218C17.1272 17.8612 16.1189 18.8695 14.8795 18.8695ZM14.8795 15.4966C14.259 15.4966 13.7543 16.0013 13.7543 16.6218C13.7543 17.2423 14.2591 17.7471 14.8795 17.7471C15.4999 17.7471 16.0047 17.2423 16.0047 16.6218C16.0047 16.0013 15.4999 15.4966 14.8795 15.4966ZM23.2928 13.1252C22.0534 13.1252 21.0452 12.1169 21.0452 10.8776C21.0452 9.63817 22.0535 8.63 23.2928 8.63C24.5322 8.63 25.5405 9.63817 25.5405 10.8776C25.5405 12.1169 24.5322 13.1252 23.2928 13.1252ZM23.2928 9.75232C22.6724 9.75232 22.1677 10.2571 22.1677 10.8774C22.1677 11.4979 22.6724 12.0027 23.2928 12.0027C23.9133 12.0027 24.418 11.4979 24.418 10.8774C24.4181 10.2571 23.9133 9.75232 23.2928 9.75232ZM31.7062 16.3164C30.4668 16.3164 29.4585 15.3081 29.4585 14.0687C29.4585 12.8294 30.4668 11.8212 31.7062 11.8212C32.9456 11.8212 33.9539 12.8294 33.9539 14.0687C33.9539 15.3081 32.9456 16.3164 31.7062 16.3164ZM31.7062 12.9436C31.0857 12.9436 30.581 13.4484 30.581 14.0687C30.581 14.6892 31.0857 15.194 31.7062 15.194C32.3267 15.194 32.8314 14.6892 32.8314 14.0687C32.8315 13.4484 32.3267 12.9436 31.7062 12.9436Z" fill-opacity="0.2" />
                            </svg>
                            <p>Turn raw data into actionable intelligence. Our ML-powered analytics help you predict trends and make smarter decisions.</p>
                        </div>
                        <a href="service-details.html" class="explore-btn"> EXPLORE MORE 
                            <svg xmlns="http://www.w3.org/2000/svg" width="17" height="9" viewBox="0 0 17 9">
                                <path
                ...
                <div class="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <div class="service-card">
                        <div class="content">
                            <h4><a href="service-details.html">Cloud Services</a></h4>
                            <svg xmlns="http://www.w3.org/2000/svg" width="55" height="55" viewBox="0 0 55 55">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    d="M44.0778 32.6851H10.9223C6.00031 32.6851 1.99609 28.6809 1.99609 23.7589C1.99609 19.0695 5.64039 15.2063 10.2457 14.8583C10.9869 10.8556 14.3574 7.86017 18.4301 7.59495C18.9968 5.40983 20.9867 3.8325 23.2985 3.8325C23.6709 3.8325 24.0403 3.87331 24.4002 3.9537C26.5923 1.44185 29.7269 0.0115967 33.0771 0.0115967C39.4317 0.0115967 44.6007 5.18085 44.6007 11.5352C44.6007 12.6628 44.4396 13.7675 44.122 14.833C49.0236 14.8564 53.0041 18.8518 53.0041 23.7589C53.0041 28.6809 48.9998 32.6851 44.0778 32.6851ZM19.0172 9.07849C15.2335 9.07849 12.0624 11.911 11.644 15.6679C11.6236 15.8515 11.5363 16.0211 11.3988 16.1443C11.2613 16.2675 11.0832 16.3358 10.8986 16.336C6.81821 16.3479 3.49821 19.6776 3.49821 23.7589C3.49821 27.852 6.82795 31.1818 10.9211 31.1818H44.0778C48.1713 31.1818 51.501 27.852 51.501 23.7589C51.501 19.6658 48.171 16.336 44.0778 16.336
/>
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    d="M22.7971 53.9659C21.7018 53.9659 20.8105 53.0746 20.8105 51.9793C20.8105 50.884 21.7018 49.993 22.7971 49.993C23.8924 49.993 24.7837 50.8843 24.7837 51.9793C24.7837 53.0743 23.8924 53.9659 22.7971 53.9659ZM22.7971 51.4964C22.6691 51.4966 22.5464 51.5475 22.4558 51.6381C22.3652 51.7286 22.3142 51.8513 22.3139 51.9793C22.3141 52.1074 22.3651 52.2302 22.4557 52.3207C22.5463 52.4113 22.669 52.4623 22.7971 52.4625C22.9252 52.4623 23.048 52.4113 23.1386 52.3207C23.2291 52.2302 23.2801 52.1074 23.2804 51.9793C23.2801 51.8513 23.229 51.7286 23.1385 51.6381C23.0479 51.5475 22.9252 51.4966 22.7971 51.4964ZM39.8709 54.9881C39.3442 54.9875 38.8393 54.778 38.4668 54.4056C38.0944 54.0332 37.8849 53.5282 37.8844 53.0015C37.8844 51.9065 38.7756 51.0152 39.8709 51.0152C40.9662 51.0152 41.8575 51.9065 41.8575 53.0015C41.8569 53.5282 41.6475 54.0332 41.275 54.4056C40.9026 54.778 40.3976 54.9875 39.8709 54.9881ZM39.8709 52.5186C39.7429 52.5188 39.6202 52.5698 39.5296 52.6603C39.439 52.7508 39.388 52.8735 39.3877 53.0015C39.3877 53.268 39.6048 53.4848 39.8709 53.4848C40.1371 53.4848 40.3542 53.268 40.3542 53.0015C40.3539 52.8734 40.3029 52.7506 40.2124 52.6601C40.1218 52.5695 39.999 52.5185 39.8709 52.5183V52.5186ZM45.4942 44.5598C44.3989 44.5598 43.5076 43.6685 43.5076 42.5732C43.5076 41.4779 44.3989 40.5869 45.4942 40.5869C46.5895 40.5869 47.4808 41.4782 47.4808 42.5732C47.4808 43.6682 46.5895 44.5598 45.4942 44.5598ZM45.4942 42.0912C45.3661 42.0914 45.2433 42.1424 45.1528 42.233C45.0622 42.3235 45.0112 42.4463 45.0109 42.5744C45.0112 42.7025 45.0622 42.8253 45.1528 42.9158C45.2433 43.0064 45.3661 43.0574 45.4942 43.0577C45.6223 43.0574 45.7451 43.0064 45.8356 42.9158C45.9262 42.8253 45.9772 42.7025 45.9774 42.5744C45.9772 42.4463 45.9262 42.3235 45.8356 42.233C45.7451 42.1424 45.6223 42.0914 45.4942 42.0912Z"/>
                            </svg>
                            <p>Deploy and scale your AI workloads on robust cloud infrastructure—optimized for performance, security, and cost efficiency.</p>
                        </div>
                        <a href="service-details.html" class="explore-btn"> EXPLORE MORE 
                            <svg xmlns="http://www.w3.org/2000/svg" width="17" height="9" viewBox="0 0 17 9">
                                <path
        ...
        <div class="container">
            <div class="row mb-60">
                <div class="col-lg-12 d-flex align-items-center justify-content-between flex-wrap gap-3">
                    ...
                    <a href="portfolio-grid.html" class="primary-btn2 wow animate fadeInRight" data-wow-delay="200ms" data-wow-duration="1500ms" data-text="View All Portfolio"><span>View All Portfolio</span></a>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="swiper portfolio-slider">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="eg-card">
                                    <div class="card-img">
                                        <img src="{{ asset('assets/theme/img/home1/portfolio-img-01.jpg') }}" alt="">
                                    </div>
                                    <div class="card-content">
                                        <a class="view-btn" href="portfolio-details.html">
                                            <img src="{{ asset('assets/theme/img/home1/right-arrow.png') }}" alt="">
                                        </a>
                                        <div class="catgory-and-title">
                                            <a href="portfolio-grid.html">AI Solutions</a>
                                            <h5><a href="portfolio-details.html">AI Workflow Automation</a></h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="eg-card">
                                    <div class="card-img">
                                        <img src="{{ asset('assets/theme/img/home1/portfolio-img-02.jpg') }}" alt="">
                                    </div>
                                    <div class="card-content">
                                        <a class="view-btn" href="portfolio-details.html">
                                            <img src="{{ asset('assets/theme/img/home1/right-arrow.png') }}" alt="">
                                        ...
                                        <div class="catgory-and-title">
                                            <a href="portfolio-grid.html">Web Development</a>
                                            <h5><a href="portfolio-details.html">Enterprise Web Platform</a></h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="eg-card">
                                    <div class="card-img">
                                        <img src="{{ asset('assets/theme/img/home1/portfolio-img-03.jpg') }}" alt="">
                                    </div>
                                    <div class="card-content">
                                        <a class="view-btn" href="portfolio-details.html">
                                            <img src="{{ asset('assets/theme/img/home1/right-arrow.png') }}" alt="">
                                        ...
                                        <div class="catgory-and-title">
                                            <a href="portfolio-grid.html">Mobile Development</a>
                                            <h5><a href="portfolio-details.html">Cross-Platform Mobile App</a></h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="eg-card">
                                    <div class="card-img">
                                        <img src="{{ asset('assets/theme/img/home1/portfolio-img-04.jpg') }}" alt="">
                                    </div>
                                    <div class="card-content">
                                        <a class="view-btn" href="portfolio-details.html">
                                            <img src="{{ asset('assets/theme/img/home1/right-arrow.png') }}" alt="">
                                        ...
                                        <div class="catgory-and-title">
                                            <a href="portfolio-grid.html">Machine Learning</a>
                                            <h5><a href="portfolio-details.html">Predictive Analytics Dashboard</a></h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="eg-card">
                                    <div class="card-img">
                                        <img src="{{ asset('assets/theme/img/home1/portfolio-img-05.jpg') }}" alt="">
                                    </div>
                                    <div class="card-content">
                                        <a class="view-btn" href="portfolio-details.html">
                                            <img src="{{ asset('assets/theme/img/home1/right-arrow.png') }}" alt="">
                                        ...
                                        <div class="catgory-and-title">
                                            <a href="portfolio-grid.html">Cloud Services</a>
                                            <h5><a href="portfolio-details.html">Cloud Infrastructure Migration</a></h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="eg-card">
                                    <div class="card-img">
                                        <img src="{{ asset('assets/theme/img/home1/portfolio-img-06.jpg') }}" alt="">
                                    </div>
                                    <div class="card-content">
                                        <a class="view-btn" href="portfolio-details.html">
                                            <img src="{{ asset('assets/theme/img/home1/right-arrow.png') }}" alt="">
                                        ...
                                        <div class="catgory-and-title">
                                            <a href="portfolio-grid.html">Data Engineering</a>
                                            <h5><a href="portfolio-details.html">Real-Time Data Pipeline</a></h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="banner-with-case-study-slider-section mb-110"> 
        <div class="row g-0">
            <div class="col-xl-4 col-lg-5">
                <div class="banner-area">
                    <img src="{{ asset('assets/theme/img/home1/case-study-banner-img.jpg') }}" alt="">
                    <div class="banner-content">
                        ...
                        <div class="banner-content-bottom wow animate fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
                            <p>Dive into our client success stories and witness firsthand the transformative impact of Sigmix Labs AI solutions.</p>
                            <a href="case-study.html" class="primary-btn1 hover-white" data-text="View All Stories"><span>View All Stories</span></a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="case-study-slider-area">
                    <div class="row d-lg-none d-flex mb-60">
                        <div class="col-lg-12 d-flex align-items-center justify-content-between flex-wrap gap-3">
                            ...
                            <a href="#" class="primary-btn1 hover-white" data-text="View All Stories"><span>View All Stories</span></a>
                        </div>
                    </div>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="case-study-card">
                                     <div class="card-img">
                                        <img src="{{ asset('assets/theme/img/home1/case-study-img1.jpg') }}" alt="">
                                     </div>
                                     <div class="card-content">
                                        <a href="case-study.html">Startup Company</a>
                                        <h4><a href="case-study-details.html">Navigating Growth A Startup Agency Success Story.</a></h4>
                                        <p>In this case study, we dissect the challenges faced and the remarkable outcomes achieved through our collaborative efforts.</p>
                                        <a href="case-study-details.html" class="learn-more-btn">Learn MORE
                                            <svg xmlns="http://www.w3.org/2000/svg" width="17" height="9" viewBox="0 0 17 9">
                                                <path
                                                    d="M12.1691 4.97333L0.234337 4.95394C0.172187 4.95394 0.112583 4.9041 0.0686358 4.81538C0.024689 4.72666 0 4.60634 0 4.48087C0 4.35541 0.024689 4.23509 0.0686358 4.14637C0.112583 4.05765 0.172187 4.00781 0.234337 4.00781L12.1694 4.02721C12.2315 4.02721 12.2911 4.07705 12.3351 4.16576C12.379 4.25448 12.4037 4.37481 12.4037 4.50027C12.4037 4.62573 12.379 4.74606 12.3351 4.83478C12.2911 4.92349 12.2313 4.97333 12.1691 4.97333Z"/>
                                                <path
                            ...
                            <div class="swiper-slide">
                                <div class="case-study-card">
                                     <div class="card-img">
                                        <img src="{{ asset('assets/theme/img/home1/case-study-img2.jpg') }}" alt="">
                                     </div>
                                     <div class="card-content">
                                        <a href="case-study.html">It Agency</a>
                                        <h4><a href="case-study-details.html">Digital Transformation Unveiled The IT Farm Experience.</a></h4>
                                        <p>This case study unveils the strategic roadmap, the technology stack deployed, and the tangible benefits reaped by Sigmix Labs.</p>
                                        <a href="case-study-details.html" class="learn-more-btn">Learn MORE
                                            <svg xmlns="http://www.w3.org/2000/svg" width="17" height="9" viewBox="0 0 17 9">
                                                <path
                                                    d="M12.1691 4.97333L0.234337 4.95394C0.172187 4.95394 0.112583 4.9041 0.0686358 4.81538C0.024689 4.72666 0 4.60634 0 4.48087C0 4.35541 0.024689 4.23509 0.0686358 4.14637C0.112583 4.05765 0.172187 4.00781 0.234337 4.00781L12.1694 4.02721C12.2315 4.02721 12.2911 4.07705 12.3351 4.16576C12.379 4.25448 12.4037 4.37481 12.4037 4.50027C12.4037 4.62573 12.379 4.74606 12.3351 4.83478C12.2911 4.92349 12.2313 4.97333 12.1691 4.97333Z"/>
                            ...
                            <div class="swiper-slide">
                                <div class="case-study-card">
                                     <div class="card-img">
                                        <img src="{{ asset('assets/theme/img/home1/case-study-img3.jpg') }}" alt="">
                                     </div>
                                     <div class="card-content">
                                        <a href="case-study.html">Creative Agency</a>
                                        <h4><a href="case-study-details.html">Overcoming Expansion An Initial Agency's Triumph</a></h4>
                                        <p>In this case study, we dissect the challenges faced, the strategies employed, and the remarkable outcomes achieved through our collaborative efforts.</p>
                                        <a href="case-study-details.html" class="learn-more-btn">Learn MORE
                                            <svg xmlns="http://www.w3.org/2000/svg" width="17" height="9" viewBox="0 0 17 9">
                                                <path
                                                    d="M12.1691 4.97333L0.234337 4.95394C0.172187 4.95394 0.112583 4.9041 0.0686358 4.81538C0.024689 4.72666 0 4.60634 0 4.48087C0 4.35541 0.024689 4.23509 0.0686358 4.14637C0.112583 4.05765 0.172187 4.00781 0.234337 4.00781L12.1694 4.02721C12.2315 4.02721 12.2911 4.07705 12.3351 4.16576C12.379 4.25448 12.4037 4.37481 12.4037 4.50027C12.4037 4.62573 12.379 4.74606 12.3351 4.83478C12.2911 4.92349 12.2313 4.97333 12.1691 4.97333Z"/>
                            ...
                            <div class="swiper-slide">
                                <div class="case-study-card">
                                     <div class="card-img">
                                        <img src="{{ asset('assets/theme/img/home1/case-study-img4.jpg') }}" alt="">
                                     </div>
                                     <div class="card-content">
                                        <a href="case-study.html">Marketing</a>
                                        <h4><a href="case-study-details.html">A Business Consulting to Increase Marketing Analaytic</a></h4>
                                        <p>This case study unveils the strategic roadmap, the technology stack deployed, and the tangible benefits reaped by Sigmix Labs.</p>
                                        <a href="case-study-details.html" class="learn-more-btn">Learn MORE
                                            <svg xmlns="http://www.w3.org/2000/svg" width="17" height="9" viewBox="0 0 17 9">
                                                <path
                            ...
                            <div class="swiper-slide">
                                <div class="case-study-card">
                                     <div class="card-img">
                                        <img src="{{ asset('assets/theme/img/home1/case-study-img5.jpg') }}" alt="">
                                     </div>
                                     <div class="card-content">
                                        <a href="case-study.html">Creative Agency</a>
                                        <h4><a href="case-study-details.html">Overcoming Expansion An Initial Agency's Triumph</a></h4>
            ...
            <div class="row mb-60">
                <div class="col-lg-12 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <div class="section-title">
                        ...
                        <h2>The Sigmix Labs Approach</h2>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row g-xl-4 gy-5 divider">
                    <div class="col-xl-3 col-lg-4 col-sm-6 wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                        <div class="single-approach">
                            <div class="img-area">
                                <img src="{{ asset('assets/theme/img/home1/approach-img1.png') }}" alt="">
                            </div>
                            <div class="dot">
                                <span></span>
                            </div>
                            <div class="approach-content-wrap">
                                <div class="scroll-content-area">
                                    <div class="content scrollTextAni">
                                        ...
                                        <p>We start by deeply understanding your business goals, challenges, and vision to define the right AI strategy.</p>
                                        <ul>
                                            <li><strong>Brainstorming: </strong>Collaborate to generate and refine innovative ideas.</li>
                                            <li><strong>Problem Identification: </strong>Identify market gaps and challenges your startup.</li>
                                            <li><strong>Strategic Planning: </strong>Develop a roadmap by strategically aligning innovative ideas.</li>
                                            <li><strong>Solution Proposals: </strong>Offer specialised remedies based on identified market gaps.</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6 wow animate fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
                        <div class="single-approach">
                            <div class="img-area">
                                <img src="{{ asset('assets/theme/img/home1/approach-img2.png') }}" alt="">
                            </div>
                            <div class="dot">
                                <span></span>
                            </div>
                            <div class="approach-content-wrap">
                                <div class="scroll-content-area">
                                    <div class="content scrollTextAni">
                                        ...
                                        <ul>
                                            <li><strong>Collaborating: </strong>Work together to produce and improve creative concepts.</li>
                                            <li><strong>Resource Allocation: </strong>Optimize planning by efficiently allocating resources and ensuring a streamlined approach.</li>
                                            <li><strong>Problem Identification: </strong>Determine your startup's obstacles and market gaps.</li>
                                            <li><strong>Solution Development: </strong>Translate identified challenges into strategic solutions and business growth.</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6 wow animate fadeInUp" data-wow-delay="600ms" data-wow-duration="1500ms">
                        <div class="single-approach">
                            <div class="img-area">
                                <img src="{{ asset('assets/theme/img/home1/approach-img3.png') }}" alt="">
                            </div>
                            <div class="dot">
                                <span></span>
                            </div>
                            <div class="approach-content-wrap">
                                <div class="scroll-content-area">
                                    <div class="content scrollTextAni">
                                        ...
                                        <ul>
                                            <li><strong>Generating ideas: </strong>Come up with and work through creative ideas together.</li>
                                            <li><strong>Prototyping Excellence: </strong>Transform ideas into tangible prototypes and user-centric design.</li>
                                            <li><strong>Iterative Development: </strong>Continuously refine and enhance solutions based on identified problems.</li>
                                            <li><strong>Problem Identification: </strong>Identify market gaps and challenges your startup.</li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6 wow animate fadeInUp" data-wow-delay="800ms" data-wow-duration="1500ms">
                        <div class="single-approach">
                            <div class="img-area">
                                <img src="{{ asset('assets/theme/img/home1/approach-img4.png') }}" alt="">
                            </div>
                            <div class="dot">
                                <span></span>
                            </div>
                            <div class="approach-content-wrap">
                                <div class="scroll-content-area">
                                    <div class="content scrollTextAni">
                                        ...
                                        <ul>
                                            <li><strong>Idea generation: </strong>Collaborate together to generate and develop creative ideas.</li>
                                            <li><strong>Continuous Testing:: </strong>Rigorous quality assurance through ongoing testing ensures robust solutions.</li>
                                            <li><strong>Performance Testing: </strong>Rigorously evaluate the functionality and efficiency of your startup's systems.</li>
                                            <li><strong>Problem Identification: </strong>Identify market gaps and challenges your startup.</li>
                                        </ul>
                                    </div>
                                </div>
        ...
        <div class="container-fluid">
            <div class="logo-wrap">
                <div class="logo-title">
                    <h6>Trusted by Forward-Thinking Businesses</h6>
                </div>
                <div class="logo-area">
                    <div class="marquee_text2">
                        <a href="#"><img src="{{ asset('assets/theme/img/home1/company-logo-01.png') }}" alt=""></a>
                        <a href="#"><img src="{{ asset('assets/theme/img/home1/company-logo-02.png') }}" alt=""></a>
                        <a href="#"><img src="{{ asset('assets/theme/img/home1/company-logo-03.png') }}" alt=""></a>
                        <a href="#"><img src="{{ asset('assets/theme/img/home1/company-logo-04.png') }}" alt=""></a>
                        <a href="#"><img src="{{ asset('assets/theme/img/home1/company-logo-05.png') }}" alt=""></a>
                        <a href="#"><img src="{{ asset('assets/theme/img/home1/company-logo-06.png') }}" alt=""></a>
                        <a href="#"><img src="{{ asset('assets/theme/img/home1/company-logo-07.png') }}" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="home1-testimonial-section two mb-110 ">
        <div class="container-fluid">
            <div class="row g-lg-4 gy-5">
                <div class="col-lg-5 d-flex align-items-center wow animate fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <div class="testimonial-content">
                        <div class="section-title">
                            ...
                            <p>These voices echo the confidence and satisfaction of clients who've witnessed firsthand the impact of our solutions. At Sigmix Labs, our clients aren't just partners.</p>
                        </div>
                        <ul class="rating-area">
                            ...
                            <li>
                                <a href="https://www.google.com/" class="single-rating google">
                                    <div class="review">
                                        <span>Review On</span>
                                        <img src="{{ asset('assets/theme/img/home1/icon/google-logo.svg') }}" alt="">
                                    </div>
                                    <div class="rating">
                                        <ul class="star">
                                            <li><i class="bi bi-star-fill"></i></li>
                            ...
                            <div class="swiper-wrapper">
                                        ...
                                        <div class="author-and-logo-area">
                                            <div class="author-area">
                                                <div class="author-img">
                                                    <img src="{{ asset('assets/theme/img/home2/testi-author-05.png') }}" alt="">
                                                </div>
                                                <div class="content">
                                                    <h6>Luke Julian</h6>
                                            ...
                                            <div class="logo">
                                                <img src="{{ asset('assets/theme/img/home1/icon/testimonial-card-logo1.svg') }}" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="testimonial-card3 style-2">
                                        ...
                                        <p>“The line's length and style can be changed to better fit your document's general layout and style. Stars, dashes, or even a graphical element are some other divider alternatives.”</p>
                                        <div class="author-and-logo-area">
                                            <div class="author-area">
                                                <div class="author-img">
                                                    <img src="{{ asset('assets/theme/img/home2/testi-author-01.png') }}" alt="">
                                                </div>
                                                <div class="content">
                                                    <h6>David Beckham</h6>
                                                    <span>CEO At astra.com</span>
                                            ...
                                            <div class="logo">
                                                <img src="{{ asset('assets/theme/img/home1/icon/testimonial-card-logo2.svg') }}" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="testimonial-card3 style-2">
                                        ...
                                        <div class="author-and-logo-area">
                                            <div class="author-area">
                                                <div class="author-img">
                                                    <img src="{{ asset('assets/theme/img/home2/testi-author-02.png') }}" alt="">
                                                </div>
                                                <div class="content">
                                                    <h6>Daniel Scoot</h6>
                                                    <span>CEO At astra.com</span>
                                            ...
                                            <div class="logo">
                                                <img src="{{ asset('assets/theme/img/home1/icon/testimonial-card-logo3.svg') }}" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="testimonial-card3 style-2">
                                        ...
                                        <div class="author-and-logo-area">
                                            <div class="author-area">
                                                <div class="author-img">
                                                    <img src="{{ asset('assets/theme/img/home2/testi-author-03.png') }}" alt="">
                                                </div>
                                                <div class="content">
                                            ...
                                            <div class="logo">
                                                <img src="{{ asset('assets/theme/img/home1/icon/testimonial-card-logo4.svg') }}" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="row g-md-4 gy-5">
                    ...
                    <div class="blog-card">
                        <div class="blog-card-img-wrap">
                            <a href="blog-details.html" class="card-img">
                                <img src="{{ asset('assets/theme/img/home1/blog-img1.jpg') }}" alt="">
                            </a>
                        ...
                        <div class="card-content">
                            <div class="blog-meta">
                                <ul class="category">
                                    <li><a href="blog-grid.html">AI &amp; Automation</a></li>
                                </ul>
                                <div class="blog-comment">
                                    <span>Comment (20)</span>
                                </div>
                            </div>
                            <h4><a href="blog-details.html">How AI is transforming the way modern businesses operate.</a></h4>
                ...
                <div class="col-lg-4 col-md-6 wow animate fadeInUp" data-wow-delay="300ms" data-wow-duration="1000ms">
                    <div class="blog-card">
                        <div class="blog-card-img-wrap">
                            <a href="blog-details.html" class="card-img">
                                <img src="{{ asset('assets/theme/img/home1/blog-img2.jpg') }}" alt="">
                            </a>
                            <a href="blog-grid.html" class="date">
                                <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 15 15">
                                    <g>
                        ...
                        <div class="card-content">
                            <div class="blog-meta">
                                <ul class="category">
                                    <li><a href="blog-grid.html">Machine Learning</a></li>
                                </ul>
                                <div class="blog-comment">
                                    <span>Comment (12)</span>
                                </div>
                            </div>
                            <h4><a href="blog-details.html">Building scalable ML pipelines for real-time data processing.</a></h4>
                            <a href="blog-details.html" class="read-more-btn">Read More
                                <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 10 10">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                        d="M8.48878 0.885308L0 9.37364L0.626356 10L9.11469 1.51122V7.38037H10V0H2.61963V0.885308H8.48878Z"/>
                ...
                <div class="col-lg-4 col-md-6 wow animate fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
                    <div class="blog-card">
                        <div class="blog-card-img-wrap">
                            <a href="blog-details.html" class="card-img">
                                <img src="{{ asset('assets/theme/img/home1/blog-img3.jpg') }}" alt="">
                            </a>
                            <a href="blog-grid.html" class="date">
                                <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 15 15">
                                    <g>
                        ...
                        <div class="card-content">
                            <div class="blog-meta">
                                <ul class="category">
                                    <li><a href="blog-grid.html">Web Development</a></li>
                                </ul>
                                <div class="blog-comment">
                                    <span>Comment (18)</span>
                                </div>
                            </div>
                            <h4><a href="blog-details.html">Choosing the right tech stack for your AI-powered product.</a></h4>
                            <a href="blog-details.html" class="read-more-btn">Read More
                                <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 10 10">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                        d="M8.48878 0.885308L0 9.37364L0.626356 10L9.11469 1.51122V7.38037H10V0H2.61963V0.885308H8.48878Z"/>
                    ...
                    <div class="contact-content">
                        ...
                        <div class="social-area wow animate fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
                            ...
                            <ul class="social-list">
                                <li>
                                    <a href="https://www.linkedin.com/company/sigmixlabs">
                                        <i class="bi bi-linkedin"></i>
                                        <span>LinkedIn</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="https://github.com/sigmixlabs">
                                        <i class="bi bi-github"></i>
                                        <span>GitHub</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="https://twitter.com/sigmixlabs">
                                ...
                                <li>
                                    <a href="https://www.instagram.com/sigmixlabs">
        ...
        <div class="container">
                ...
                <div class="row align-items-center justify-content-center">
                    ...
                    <div class="col-lg-4 col-md-6 d-flex justify-content-lg-center justify-content-md-end justify-content-sm-start">
                        <div class="footer-logo-area">
                            <div class="logo-bg">
                                <img src="{{ asset('assets/theme/img/home1/footer-logo-bg.png') }}" alt="" class="light">
                                <img src="{{ asset('assets/theme/img/home1/footer-logo-bg-dark.png') }}" alt="" class="dark">
                            </div>
                            <div class="logo">
                    ...
                    <div class="col-lg-4 col-md-8
                     d-flex justify-content-lg-end justify-content-sm-end">
                        <div class="footer-widget">
                            ...
                            <div class="content">
                                <p>Welcome to Sigmix Labs, where AI meets engineering excellence. We build intelligent digital products that drive real business outcomes.</p>
                            </div>
                            <ul class="rating-area">
                                <li>
                                    <a href="https://clutch.co/" class="single-rating">
                                        <div class="review">
                                            <span>Review On</span>
                                            <img src="{{ asset('assets/theme/img/home1/icon/clutch-logo.svg') }}" alt=""  class="logo-dark">
                                            <img src="{{ asset('assets/theme/img/home1/icon/clutch-logo-white.svg') }}" alt="" class="logo-light">
                                        </div>
                                        <div class="rating">
                                            <ul class="star">
                                                <li><i class="bi bi-star-fill"></i></li>
            ...
            <div class="contact-area">
                ...
                <div class="hotline-area">
                    ...
                    <div class="content">
                        <span>Address</span>
                        <h6><a href="https://maps.google.com/?q=DHA+Lahore+Pakistan">DHA Lahore, Pakistan</a></h6>
                    </div>
                </div>
                <div class="hotline-area">
                    <div class="icon">
