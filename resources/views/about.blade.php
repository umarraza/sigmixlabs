        ...
        <div class="row g-lg-5 gy-5 align-items-center mb-90">
            <div class="col-lg-6 wow animate fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
                <div class="about-img-area">
                    <img src="{{ asset('assets/theme/img/home1/about-img.jpg') }}" alt="About Sigmix Labs" class="img-fluid main-img">
            ...
            <div class="col-lg-6 wow animate fadeInRight" data-wow-delay="300ms" data-wow-duration="1500ms">
                ...
                <p class="mb-20">Sigmix Labs is a technology company headquartered in DHA Lahore, Pakistan. We partner with businesses of all sizes — from ambitious startups to established enterprises — to design, build, and scale digital products that matter.</p>
                <p class="mb-30">Our multidisciplinary team of engineers, designers, and strategists brings together deep technical skills and creative problem-solving to deliver solutions that are both innovative and practical.</p>
        ...
        <div class="row g-4">
            <div class="col-lg-4 col-md-6 wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                <div class="mission-card">
                    ...
                    <h4>Our Mission</h4>
                    <p>To empower businesses worldwide with innovative, reliable, and scalable technology solutions that fuel growth and create lasting competitive advantages.</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 wow animate fadeInUp" data-wow-delay="300ms" data-wow-duration="1500ms">
                <div class="mission-card active">
                    ...
                    <h4>Our Vision</h4>
                    <p>To be the most trusted technology partner for businesses across South Asia and beyond, known for engineering excellence, innovation, and integrity.</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 wow animate fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
                <div class="mission-card">
                    ...
                    <h4>Our Values</h4>
                    <p>Transparency, innovation, quality, and accountability are the cornerstone of everything we do. We build relationships on trust and deliver on our promises.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row mb-60 align-items-end">
            ...
            <div class="col-lg-5 wow animate fadeInRight" data-wow-delay="300ms" data-wow-duration="1500ms">
                <p>Our diverse team of engineers, designers, and strategists brings together decades of combined experience across web, mobile, AI, and cloud technologies.</p>
            </div>
        </div>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-3 col-md-6 wow animate fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
                <div class="team-card">
                    <div class="team-img">
                        <img src="{{ asset('assets/theme/img/home1/team/team3.jpg') }}" alt="Design Lead" class="img-fluid">
                        <div class="team-social">
                            <ul>
                                <li><a href="https://www.linkedin.com/company/sigmixlabs"><i class="bi bi-linkedin"></i></a></li>
            ...
            <div class="col-lg-3 col-md-6 wow animate fadeInUp" data-wow-delay="500ms" data-wow-duration="1500ms">
                <div class="team-card">
                    <div class="team-img">
                        <img src="{{ asset('assets/theme/img/home1/team/team4.jpg') }}" alt="Engineering Lead" class="img-fluid">
                        <div class="team-social">
                            <ul>
                                <li><a href="https://www.linkedin.com/company/sigmixlabs"><i class="bi bi-linkedin"></i></a></li>
                                <li><a href="https://github.com/sigmixlabs"><i class="bi bi-github"></i></a></li>
