    ...
    <header class="header-area style-2">
        <div class="container d-flex flex-nowrap align-items-center justify-content-between">
            <div class="company-logo">
                <a href="{{ route('home') }}" class="logo-dark"><img alt="image" class="img-fluid" src="{{ asset('assets/theme/img/logo-light.svg') }}"></a>
                <a href="{{ route('home') }}" class="logo-light"><img alt="image" class="img-fluid" src="{{ asset('assets/theme/img/logo-light.svg') }}"></a>
            </div>
                        ...
                        <div class="footer-widget">
                            ...
                            <div class="menu-container">
                                <ul class="widget-list">
                                    <li><a href="{{ route('services') }}">Managed Services</a></li>
                                    <li><a href="{{ route('services') }}">IT Consulting &amp; Advisory</a></li>
                                    <li><a href="{{ route('services') }}">Cyber Security</a></li>
                                    <li><a href="{{ route('services') }}">Web Development</a></li>
                                    <li><a href="{{ route('services') }}">Mobile Development</a></li>
                                </ul>
                                <ul class="widget-list">
                                    <li><a href="{{ route('services') }}">Cloud Services</a></li>
                                    <li><a href="{{ route('services') }}">Network Connectivity</a></li>
                                    <li><a href="{{ route('services') }}">ERP Solutions</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
